...
agent = DQNAgent(env_name, env, 100, learning_rate=0.001, start_epsilon=1.0, discount_factor=0.95, decay_rate=0.05,
                 make_checkpoint=True, is_state_box=True)
# agent.train()
nn = agent.load("/home/dsalwala/NUIG/Thesis/rl-algos/data/CartPole-v0_60.npy")
